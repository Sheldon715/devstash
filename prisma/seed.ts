    ...
    items: [
      {
        ...
        description: "Quick status, branching, and sync commands.",
        typeKey: "command",
        content: `git status
...
git rebase origin/main`,
      },
      {
        ...
        description: "Build, inspect, and clean up containers locally.",
        typeKey: "command",
...
docker system prune`,
      },
      {
        ...
        description: "Inspect open ports and stop runaway processes.",
        typeKey: "command",
        content: `lsof -i :3000
ps aux | grep node
kill -9 <pid>`,
      },
      {
        ...
        description: "Install, upgrade, and audit JavaScript dependencies.",
        typeKey: "command",
        content: `npm install
npm outdated
npm update
    ...
    items: [
      {
        ...
        description: "Reference for utilities, theming, and responsive design patterns.",
        typeKey: "link",
        isFavorite: true,
      ...
      {
        title: "shadcn/ui",
        description: "Composable component patterns for React applications.",
        typeKey: "link",
        url: "https://ui.shadcn.com/",
      },
      {
        title: "Material Design",
        description: "Cross-platform design guidance for layout, motion, and accessibility.",
        typeKey: "link",
        url: "https://m3.material.io/",
      },
      {
        title: "Lucide icons",
        description: "Open-source icon library used throughout modern web apps.",
        typeKey: "link",
