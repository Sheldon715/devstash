...
export function AuthShell({ children, eyebrow, subtitle, title }: AuthShellProps) {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#05060f] text-zinc-50 [background-image:radial-gradient(circle_at_16%_8%,rgba(95,126,234,0.2),transparent_31rem),radial-gradient(circle_at_82%_4%,rgba(141,107,232,0.18),transparent_29rem),radial-gradient(circle_at_52%_42%,rgba(231,213,173,0.06),transparent_32rem),linear-gradient(180deg,#05060f_0%,#090b18_44%,#05060f_100%)]">
      ...
      <div className="relative mx-auto grid min-h-screen w-full max-w-7xl items-center gap-10 px-5 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:px-12">
        <section className="space-y-8">
          ...
          >
            <span className="grid size-9 place-items-center rounded-lg border border-white/12 bg-gradient-to-br from-blue-500/90 via-indigo-500/85 to-violet-500/85 text-xs font-black text-white shadow-[0_12px_30px_rgba(99,102,241,0.22)]">
              DS
            </span>
            DevStash
          </Link>
